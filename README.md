...
deep Q-network solution to the unity banana navigation problem
...
Most of the source codes of this project, `banana_nav` are stored in the `banana_nav` directory.
